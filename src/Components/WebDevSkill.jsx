...
import clickMe from "./Styles/Images/ClickMe.png";
...
<div className="ClikMeItem">
    <button className="ClickMeBtn" onClick={ToggleSkillsBtn} > See My Skills
      <span className="toggle-statsBar "/><a href="/"></a></button>

</div>

<div className="ClikMeItem">

<img className="ClickME" src={clickMe}></img>
</div>
